...
dataset_training_set = pd.read_csv("Google_Stock_Price_Train.csv")
training_set = dataset_training_set.iloc[:,1:2].values
...
regressor.add(LSTM(units = 50 ,activation = 'sigmoid' ,return_sequences =True,input_shape = (x_train.shape[1], 1)))
...
dataset_total = pd.concat((dataset_training_set['Open'],test_set['Open']), axis = 0)
